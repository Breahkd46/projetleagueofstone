            ...
            <div className="flip" onClick={this.props.onClick}>
                <div className={`card flip`} >
                    <div className="face front">
                        <img alt={`${this.props.name} card`} src={`https://ddragon.leagueoflegends.com/cdn/img/champion/splash/${this.props.img}_0.jpg`}/>
                        <div className="card-text container">
                            <div className={"card-text-item-left"}>
                                <p>A : {this.props.info?this.props.info.attackdamage:''}</p>
                                <p>M : {this.props.info?this.props.info.magic:''}</p>
                            </div>
